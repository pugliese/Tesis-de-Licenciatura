...
% T alta el ensamble empieza a tener probabilidad no nula (y razonable como para que ocurra cada tanto) de aceptar la superposición de 2 partículas a pesar del costo energético.
% Cuanto mayor es T, mayor es el costo que puede aceptar (más cerca las pone) y eventualmente estos "eventos" terminan desdibujando completamente la región excluída hasta que quede como la de un gas ideal
