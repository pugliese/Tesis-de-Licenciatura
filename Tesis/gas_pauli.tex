...
\subsection{Area excluida}{\label{sec:area_exc}}
...
\begin{figure}[H]
    ...
    Esta zona surge por cuestiones estadísticas (probablidad nula de superposición exacta) y no tiene relación alguna con la exclusión de Pauli.}
...
Para cada densidad tomamos $\Delta r = L/800$, por lo que tendriamos $400$ valores de $r$.
Esto se debe a que para un sistema con condiciones perdiódicas de contorno y criterio de mínima imagen, no tiene sentido analizar $r\geq L/2$ por la geometría cúbica del sistema.
...
Esto es razonable respecto a nuestro argumento anterior, pues aludimos a propiedades cualitativas del potencial de Pauli, independientes de sus parámetros.
