\section{Distribución de Boltzmann}{\label{ap:boltzmann}}
...
Una de estas es la aproximación de Padé por una función racional (cociente de polinomios)\cite{BOOK:SPR_NUM}
...
\begin{figure}[H]
	\centering
	\subfigure[Recurrencia entre elementos]{\includegraphics[width=0.4\columnwidth]{apendice/esquema_wynn.png}{\label{fig:wynn_esquema}}}
	\subfigure[Ejemplo del cómputo para el caso $p=1$]{\includegraphics[clip, width=0.85\columnwidth]{apendice/ejemplo_wynn.png}{\label{fig:wynn_ejemplo}}}
...
\begin{figure}[H]
	\centering
	\subfigure[Valor absoluto]{\includegraphics[width=0.49\columnwidth]{apendice/ejemplo_wynn_log.png}}
	\subfigure[Error relativo]{\includegraphics[width=0.49\columnwidth]{apendice/ejemplo_wynn_log_error.png}}
...
Para esto, utilizamos el conocido lema de Sommerfeld\cite{BOOK:PATHRIA} que nos permite aproximar
...
\begin{figure}[H]
	\centering
	\subfigure[Función $f_{3/2}(z)$ utilizada para obtener $\mu(N,V,T)$]{\includegraphics[width=0.49\columnwidth]{apendice/F32.png}}
%	\hspace{0.05\columnwidth}
	\subfigure[Función $f_{5/2}(z)$ asociada a la presión del sistema]{\includegraphics[width=0.49\columnwidth]{apendice/F52.png}}
...
\begin{multicols}{3}
\begin{lstlisting}[language=C, basicstyle=\scriptsize\tt]
float forces1(...){
	...
	for(i=0;i<N;i++){
		for(j=i+1;j<N;j++){
